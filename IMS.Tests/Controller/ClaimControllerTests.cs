...
//        //_controller = new ClaimsController(null, _mockClaimService.Object);
...
//        {
//            new Claim(ClaimTypes.NameIdentifier, "123"),  // Ensure it matches dto.AgentId
//            new Claim(ClaimTypes.Role, Roles.Agent)       // Assign the correct role
//        };
