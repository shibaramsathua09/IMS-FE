...
//    {
//        var dto = new AvailablePolicyResponseDto
//        {
//            Name = "",
//            CoverageDetails = ""
//        };
...
//    {
//        var dto = new AvailablePolicyRequestDto
//        {
//            Name = "",
//            CoverageDetails = ""
...
//    {
//        var dto = new AssignAgentRequestDto
//        {
//            AgentId = 101
//        };
...
//    {
//        var dto = new PolicyRequestStatusResponseDto
//        {
//            Status = "Pending",
//            AvailablePolicyName = "Test",
//            CustomerName = "Test",
...
public class PoliciesControllerTests
{
    ...
    //    _mockPolicyService.Setup(s => s.GetExistingPolicyByNameAsync(123,"Test")).ReturnsAsync((object)null);
    //    _mockPolicyService.Setup(s => s.RequestPolicyAsync(dto)).ReturnsAsync(response);
    ...
    //public async Task GetAssignedPolicies_ReturnsOk_WhenSuccess()
    //{
    //    var response = OperationResult<List<AgentAssignedPolicyResponseDto>>.Success([]);

    //    _mockPolicyService.Setup(s => s.GetAssignedPoliciesAsync());
    ...
    //public async Task GetRegisteredPolicies_ReturnsOk_WhenSuccess()
    //{
    //    var response = OperationResult<List<CustomerPoliciesResponseDto>>.Success([]);

    //    _mockPolicyService.Setup(s => s.GetRegisteredPoliciesAsync());
    ...
    //public async Task GetPolicyRequests_ReturnsOk_WhenSuccess()
    //{
    //    var response = OperationResult<List<PolicyRequestStatusResponseDto>>.Success(new List<PolicyRequestStatusResponseDto>());

    //    _mockPolicyService.Setup(s => s.GetPolicyRequestsAsync());
